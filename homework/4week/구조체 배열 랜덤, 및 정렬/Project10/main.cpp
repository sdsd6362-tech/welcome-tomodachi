...
void main()
{
	...
	printStudentDB(pST_DB); printf("\n");

	sortStudents(pST_DB, ST_ID, INCR);
	printf("After sorting students by increasing order of student ID:\n");
	printStudentDB(pST_DB); printf("\n");

	sortStudents(pST_DB, MAJOR, INCR);
	printf("After sorting students by increasing order of major:\n");
	printStudentDB(pST_DB); printf("\n");
	
	sortStudents(pST_DB, GPA, DECR);
	printf("After sorting students by decreasing order of GPA:\n");
	printStudentDB(pST_DB); printf("\n");
	
	sortStudents(pST_DB, NAME, INCR);
	printf("After sorting students by increasing order of studentname:\n");
	printStudentDB(pST_DB); printf("\n");
}